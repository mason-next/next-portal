      ...
      <header className="flex h-16 items-center justify-between border-b bg-background px-4 md:px-6">
        ...
        <div className="flex items-center gap-8">
          <Link href="/projects" className="text-sm font-semibold tracking-tight">
            <Image src="/NEXT-logo.png" alt="NEXT Portal" width={2910} height={386} className="h-7 w-auto md:h-8" priority />
          </Link>
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between border-b px-4">
          <Link href="/projects" onClick={() => setMenuOpen(false)}>
            <Image src="/NEXT-logo.png" alt="NEXT Portal" width={2910} height={386} className="h-7 w-auto" priority />
          </Link>
          <button
            type="button"
            onClick={() => setMenuOpen(false)}

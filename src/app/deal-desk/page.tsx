...
export default function DealDeskPage() {
  ...
  // Collect all unique team member names across all quotes
  ...
  // Filter quotes based on current user role
    ...
    <div className="mx-auto max-w-7xl p-8 space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <Link href="/deal-desk/my-commissions">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <QuoteTable quotes={visibleQuotes} onDelete={isManagement ? remove : undefined} />
        </>
      )}
